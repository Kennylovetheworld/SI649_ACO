var antColony = (function(ps) {
    ...
    function _initGraphics() {
        ...
        legend_pic.position.y = 820;
        container.addChild(legend_pic);

        legendText = new PIXI.Text("& Maize line: the current shortest path for TSP problem", { font: "24px Lato", fill: "#FFCB05", align: "left" });
        legendText.position.x = 60;
        legendText.position.y = 830;
        container.addChild(legendText);
        ...
        legend_pic.scale.y = 0.05;
        legend_pic.position.x = 30;
        legend_pic.position.y = 860;
        container.addChild(legend_pic);

        legendText = new PIXI.Text("& White line: the current candidate solution generated by Ants", { font: "24px Lato", fill: "white", align: "left" });
        legendText.position.x = 60;
